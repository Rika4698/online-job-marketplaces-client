...
<section className="pt-16 pb-7 border-t border-gray-200">
   ...
   <img className="w-[146px] h-[70px]  " src="https://i.ibb.co/9yRK3c0/work-wave-high-resolution-logo-transparent-2.png" alt="" />
   
   </div>
            <p className="text-base font-normal text-gray-500 max-[470px]:text-center mt-0 ">Take the First Step Towards Success!</p>
            <div className="flex items-center max-[470px]:justify-center gap-5">
              <a href=""
                className="p-2 text-black rounded transition-all duration-500 hover:bg-emerald-700 focus-within:bg-emerald-700 hover:text-white focus-within:outline-0 focus-within:text-white">
              ...
              <a href=""
                className="p-2 h-10 w-10 flex items-center justify-center text-black rounded transition-all duration-500 hover:bg-emerald-700 focus-within:outline-0 focus-within:bg-emerald-700 hover:text-white focus-within:text-white">
              ...
              <a href=""
               className="p-2 text-black group rounded transition-all duration-500 hover:bg-emerald-700 focus-within:bg-emerald-700 hover:text-white focus-within:outline-0 focus-within:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    fill="currentColor" />
                  <path className="fill-white transition-all divide-gray-500 group-hover:fill-emerald-700 group-focus-within:fill-emerald-700"
                    d="M10.2939 14.7206L14.8132 12.1041L10.2939 9.48767V14.7206Z" fill="" />
                </svg>
              </a>
            </div>
          </div>
          <div className="flex  flex-col min-[470px]:flex-row min-[470px]:items-center   justify-center lg:justify-start gap-3 xl:mt-[-16px]">
            <Link to='/'>
            <button
             className="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold text-white bg-emerald-700 shadow-transparent shadow-sm transition-all duration-500 hover:shadow-emerald-300 hover:bg-emerald-900">Start
              Project
            ...
            <Link to='/contact'>
            <button
             className="flex items-center max-[470px]:justify-center gap-2 border-2 border-emerald-700 py-2.5 pr-5 pl-7 rounded-full text-base font-semibold text-emerald-700 bg-white shadow-transparent shadow-sm transition-all duration-500 hover:shadow-emerald-300 hover:bg-emerald-700 hover:text-white ">Contact Us
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
        ...
        <div className="w-full lg:max-w-full mx-auto flex flex-col min-[470px]:flex-row justify-between gap-6 sm:gap-20 md:gap-10 xl:gap-24">
          <div className="">
            <h6 className="text-lg font-medium text-gray-900 mb-7 max-[470px]:text-center ">Pages</h6>
            <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href="/"
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Home</a>
              </li>
              <li><a href="/about"
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">About</a>
              </li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Pricing</a>
              </li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Pro
                  Version</a></li>
            </ul>
          </div>
          <div className="">
            <h6 className="text-lg font-medium text-gray-900 mb-7 max-[470px]:text-center">Products</h6>
            <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Figma
                  UI System</a></li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Icons
                  Assets</a></li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Responsive
                  Blocks</a></li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Components
                  Library</a></li>
            </ul>
          </div>
          <div className="">
            ...
            <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">FAQs</a>
              </li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Quick
                  Start</a></li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Documentation</a>
              </li>
              <li><a href=""
                 className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">User
                  Guide</a></li>
            </ul>
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-7">
        <p className="font-normal text-sm text-gray-500">©<a href="/">Work Wave</a>2025, All rights reserved.</p>
        <ul className="flex items-center gap-9">
          <li><a href="" className="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Terms</a></li>
          <li><a href="" className="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Privacy</a></li>
          <li><a href="" className="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-emerald-700 focus-within:outline-0 focus-within:text-emerald-700">Cookies</a></li>
        </ul>
      </div>
    </div>
  </section>
